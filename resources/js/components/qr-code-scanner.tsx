    ...
    <div className="space-y-4">
      <form onSubmit={handleManualSubmit} className="flex flex-col sm:flex-row gap-2 mb-4">
        <input
          ...
          className="flex-1 px-4 py-2 rounded-lg border border-gray-300 text-gray-900 bg-white placeholder-gray-400 hover:border-gray-400 focus:border-blue-500 focus:ring-0 focus:outline-none text-base"
        />
        <button
          type="submit"
